...
class Classmate(Person):
    ...
    def introduce(self):
        print(f'Привет! я из класса {self.group} , меня зовут {self.name} , я родился в {self.birth_date} , я {self.occupation}')
...
class Friend(Person):
    ...
    def introduce(self):
        print(f'Привет меня зовут {self.name} , я родился в {self.birth_date} , я  {self.occupation} , мое хобби {self.hobby}')
